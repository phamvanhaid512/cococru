...
import { user } from "../config/mailer.js";
import {  Minigame, Task, GameHistory, User,Role } from "../models/index.js";
import { errorCode } from '../utils/util.helper.js';
import { ReE, ReS } from '../utils/util.service.js';
import { deleteFile } from '../lib/deletefile.js';
import { createCareer } from '../dao/career.dao.js'
//Create Career 
...
export async function getRoleById(req, res, next) {
  try {
    ...
    const roleById = await Role.findByPk(roleId, {
